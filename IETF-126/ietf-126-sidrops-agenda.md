...
***Room: [Grand Klimt Hall 2](https://datatracker.ietf.org/meeting/126/floor-plan?room=grand-klimt-hall-2)***
...
- Speaker: various, Job Snijders to lead discussion
    - Duration: 15 minutes (Cumulative Time: *20 Minutes*)
...
- Speaker: Guozhen Dong 
  ...
  - Expected outcome: Community feedback 
  - Datatracker Link: 
    - https://datatracker.ietf.org/doc/draft-dong-sidrops-rpki-rtr-moa-pdu/
...
- Speaker: K. Sriram
  ...
  - Datatracker link: 
    - https://datatracker.ietf.org/doc/draft-geng-sidrops-asra-profile/ 
    - https://datatracker.ietf.org/doc/draft-sriram-sidrops-asra-verification/
...
- Speaker: Jishnu Roy
  ...
  - Datatracker Link:  
    - https://datatracker.ietf.org/doc/draft-liu-sidrops-rpki-rtr-over-quic/03/
...
#### A.1 Information Asymmetry and Deployment Gaps in RPKI-based Route Origin Validation
- Speaker: Weiqiang Cheng
  ...
  - Datatracker Link: 
    - https://datatracker.ietf.org/doc/draft-cheng-sidrops-rpki-rov-gap-analysis/
...
- Speaker: Mingqing Huang
  ...
  - Datatracker Link:  
    - https://datatracker.ietf.org/doc/draft-huang-sidrops-source-pre-validation/
